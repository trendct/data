...
A chart used in this analysis is based on code form [rud.is](https://rud.is/b/2016/04/17/ggplot2-exercising-with-ggalt-dumbbells/).
...
```{r getting_data, warning=FALSE, message=FALSE, comment=FALSE, results=FALSE}
