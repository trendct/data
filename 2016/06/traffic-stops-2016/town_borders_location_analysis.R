# Some exploratory charts looking at officer-level data
...
# bringing in the location-specific data from location_prep.R

source("location_prep.R")

# eliminating rows with no latitude and longitude data
mega_no_na <- mega[!is.na(mega$InterventionLocationLatitude),]

# Creating a leaflet map of all 34,000 stops
...
## Stops within town
## Calculating points in polygons within town borders
## Two sets of borders-- one within 40 percent of the town's geography, and the other 60 percent
...
## Creating a choropleth of the points to polygons above
## Choropleth totals
