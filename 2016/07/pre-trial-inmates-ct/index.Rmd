...
This is the methodology used for the [Trend CT](http://www.trendct.org) story: [Who’s sitting in pretrial detention in Connecticut](http://trendct.org/2016/07/19/who-where-and-how-often-people-are-stunned-by-police-in-connecticut/). These are exploratory tables and charts— some of which I did not include in the final story for various reasons.
