...
write.csv(ct_combined, "ct_combined.csv")

# Exploring the data in Excel, cleaning rows, adding debt to earnings ratio
...
trendchart(rate_bottom, headline = "Delete me", subhead = "Median salary based on 10 years after enrollment in 2001.", src = "US Department of Education",
           byline = "TrendCT.org", type = "column", xTitle = "", yTitle = "",
           xSuffix = "", ySuffix = "", xPrefix = "", yPrefix = "", option = "")